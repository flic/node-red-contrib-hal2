...
| `thing_name` | `string` | no | Partial, case-insensitive name match (alternative to thing_id) |
| `item_id` | `string` | no | Item ID (from get_all_states) |
| `item_name` | `string` | no | Item name, partial case-insensitive match (alternative to item_id) |
